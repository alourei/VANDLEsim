...
{ 
  ...
  // Creating ntuple
  //
  analysisManager->CreateNtuple("OptPhotons", "Detected photons");
  ...
  analysisManager->CreateNtuple("OptPhotonsSum", "Tot nr of detected photons");
  analysisManager->CreateNtupleDColumn("eventID");
  analysisManager->CreateNtupleDColumn("detID");
  analysisManager->CreateNtupleDColumn("pmtID");
...
{ 
  ...
  // Open an output file
  //
  G4String fileName = "VANDLEoutput";
